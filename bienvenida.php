...
<html>
  ...
  <body>
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Puedes empezar a personalizar  y administrar tus sitios ya.</p>
        <hr class="my-4">
        <a class="btn btn-primary btn-lg" href="bienvenida.php#servicios" role="button">Continuar</a>
    </div>
